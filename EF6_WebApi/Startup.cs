...
namespace EF6_WebApi
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            var connectionString = Configuration.GetConnectionString("SchoolDBEntities");
            services.AddSqlServer<SchoolDBContext>(connectionString, sqlOption => sqlOption.UseNetTopologySuite());
        }
